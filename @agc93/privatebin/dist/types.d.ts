export declare type Compression = 'zlib' | 'none';
export declare type Format = 'plaintext' | 'syntaxhighlighting' | 'markdown';
export declare type Expiry = '5min' | '10min' | '1hour' | '1day' | '1week' | '1month' | '1year' | 'never';
/**
